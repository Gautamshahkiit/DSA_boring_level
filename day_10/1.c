// 1.Write a menu driven program to implement the following
  // a.Input Restricted Double Ended Queue
  //   i.Insert_right()
  //   ii.Delete_left()
  //   iii.Delete_right()
  //   iv.Display()//It is required to know the correctness of code. Display from front to rear
  // b.Output Restricted Double ended Queue
  //   i.Delete_left()
  //   v.Insert_right()
  //   vi.Insert_left()
  //   ii.Display()
